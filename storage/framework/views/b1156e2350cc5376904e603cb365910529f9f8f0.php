            ...
            <?php $__currentLoopData = $data->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-nowrap">
                        <a href="/<?php echo e($item->uniqueid); ?>" class="btn btn-sm btn-primary">
                            View Result
                        </a>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\binec\resources\views/index.blade.php ENDPATH**/ ?>